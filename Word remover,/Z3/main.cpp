...
int main ()
{
    ...
    std::cout << "Najveci element niza je ";
    i1 = std::max_element(a.begin(),a.end());
    i2 = std::min_element(a.begin(),a.end());
    std::cout<<*i1<<std::endl;
    std::cout << "Najmanji element niza se pojavljuje " << std::count(a.begin(),a.end(),*std::min_element(a.begin(),a.end()))  << " puta u nizu" << std::endl;
    std::cout << "U nizu ima " << std::count_if(a.begin(),a.end(),Kvadrat)  << " brojeva koji su potpuni kvadrati" << std::endl;
